namespace FastAndFurious.ConsoleApplication.Common.Constants
{
    public class GlobalConstants
    {
        ...
        public const string CannotAddNullObjectsToCollectionExceptionMessage = "Cannot add null object to a collection";
        public const string CannotSignTheSameItemTwiceExceptionMessage = "Cannot sign the same {0} to a {1}";
        ...
        public const string TypeSuccessfullyCreatedMessage = "{0} - successfully created!";
